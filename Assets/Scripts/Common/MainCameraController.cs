...
public class MainCameraController : MonoBehaviour {
    ...
    void FixedUpdate() {
        ...
        if (isZoom) Camera.main.orthographicSize = Mathf.Lerp(Camera.main.orthographicSize, InitZoomSize - ZoomAmount, Time.deltaTime*ZoomSpeed);
        else Camera.main.orthographicSize = Mathf.Lerp(Camera.main.orthographicSize, InitZoomSize, Time.deltaTime*ZoomSpeed);
    }
